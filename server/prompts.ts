...
export function buildMacroSwapLabPrompt(
  ...
  return [
    ...
    "While the promise is in flight, disable the button and show a pending label. On result.ok write a success message into #swapStatus, otherwise write result.error into it.",
